tool_schemas = [
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "query": {"type": "string"},
                    "docs_dir": {"type": "string", "default": "source_repos/LAB_6/lab6_agent_antigravity/data/docs"},
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "out_path": {"type": "string", "default": "integrated_system/logs/lab6_keyword_plot.png"}
                },
                "required": ["items"]
            }
        }
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "keyword": {"type": "string"},
                    "logs_dir": {"type": "string", "default": "integrated_system/logs"},
